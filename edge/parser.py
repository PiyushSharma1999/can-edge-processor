...
class CANParser:
    ...
    def decode_message(self, msg: can.Message):
        ...
        try:
            # cantools handles: bit extraction, endianess, sign, scale, offset
            decoded = self.db.decode_message(msg.arbitration_id, msg.data,
                                             decode_choices=True)
            frame.signals = {k: float(v) if not isinstance(v, str) else vars
    ...
    def parse_asc_file(self, asc_path):
    ...
    def print_signal_summary(self, frames):
